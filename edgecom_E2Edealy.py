...
def initialize_weights(shape):
    return tf.Variable(tf.random.normal(shape, stddev=0.1, seed=31), trainable=True)
...
# t_ex = 1/2*(w1+w2)
for fmc in np.arange(8,12.5,0.5):
    fmc = fmc*1e9
...
df1.to_excel('edgecom_E2Edelay_0225.xlsx',  index=False)
plt.figure()
